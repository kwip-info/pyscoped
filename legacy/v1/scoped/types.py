...
class ActionType(Enum):
    ...
    CONNECTOR_SUBMIT = "connector_submit"
    CONNECTOR_APPROVE = "connector_approve"
    CONNECTOR_REJECT = "connector_reject"
    CONNECTOR_SUSPEND = "connector_suspend"
    CONNECTOR_REVOKE = "connector_revoke"
    CONNECTOR_SYNC = "connector_sync"
    CONNECTOR_POLICY_ADD = "connector_policy_add"
    MARKETPLACE_PUBLISH = "marketplace_publish"
    MARKETPLACE_INSTALL = "marketplace_install"
    MARKETPLACE_VERSION_UPDATE = "marketplace_version_update"
    MARKETPLACE_DEPRECATE = "marketplace_deprecate"
    MARKETPLACE_REMOVE = "marketplace_remove"
    MARKETPLACE_VISIBILITY_CHANGE = "marketplace_visibility_change"
